...
start "Installing Cloudflare WARP" cmd.exe @cmd /k "curl -o ./cloudflare/cloudflare-x64.msi https://1.1.1.1/Cloudflare_WARP_Release-x64.msi --create-dirs & msiexec /i "./cloudflare/cloudflare-x64.msi" & echo Cleaning downloaded files... & RMDIR /Q/S cloudflare & pause"
